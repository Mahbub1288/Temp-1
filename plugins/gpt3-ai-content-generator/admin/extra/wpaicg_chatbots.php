    ...
    jQuery(document).ready(function ($){
        ...
        $('.wpaicg-bot-edit').click(function (){
            ...
            $.each(fields, function (key, field){
                ...
                if(key === 'voice_service' || key === 'openai_model' || key === 'elevenlabs_model' || key === 'openai_voice' || key === 'openai_output_format' || key === 'openai_voice_speed' || key === 'voice_language' || key === 'voice_name' || key === 'voice_device' || key === 'voice_speed' || key === 'voice_pitch'){
